...
(function ($) {
    if($.fn.ajaxForm == undefined) {
        $.getScript(("https:" == document.location.protocol ? "https://" : "http://") + location.host + "/js/jquery.form.js");
    }
    var feature = {};
    ...
    $.fn.uploadFile = function (options) {
        ...
        var s = $.extend({
            ...
            dragDropStr: "<span><b>Файлы фотографий можно просто перетащить сюда</b></span>",
            abortStr: "Отмена",
            cancelStr: "Отмена",
            deletelStr: "Удалить",
            doneStr: "Завершено",
            multiDragErrorStr: "Multiple File Drag &amp; Drop is not allowed.",
            extErrorStr: "не загружен. Допустимые расширения: ",
            duplicateErrorStr: "is not allowed. File already exists.",
            sizeErrorStr: "не загружен. Разрешенный максимальный размер: ",
            uploadErrorStr: "Загрузка не разрешена",
            maxFileCountErrorStr: " не загружен. Максимально доступное кол-во для загрузки:",
...
//alert('preview');
                ...
                //***************Preview
                //console.log($.md5(files[i].name));
                var img = document.createElement("img");
                img.width = 'auto';
                img.height = 80;
                img.style.height = '80px';
                img.style.width = 'auto';
                $(img).attr('fileload_id', '');
                $(img).attr('class', 'otherfileborder');
                $(img).attr('md5id', $.md5(files[i].name));
        ...
        function createProgressDiv(obj, s) {
            ...
            if(s.showQueueDiv)
            {
                ...
                $('#fileuploader_list').append(this.statusbar);
            return this;
        }
