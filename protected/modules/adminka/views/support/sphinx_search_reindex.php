...
<div style="margin-left: 20px;">
    <h2 style="font-size: 13px; margin-top: 10px; font-weight: bold;">Переиндексация поисковых фраз</h2>

    <div>
        <form>
            Стартовый ID: <input type="text" name="min_id" id="min_id" value="0" style="width: 200px;">
            <br>
...
<script>
    $('#index_button').click(function(){
        ...
        $.ajax({
            url: "<?= Yii::app()->createUrl('/adminka/support/sphinx_search_reindex_run');?>",
            method: "post",
            dataType: 'json',
            data:{
                start_id: $('#min_id').val()
