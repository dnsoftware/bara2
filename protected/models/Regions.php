...
{
    // Смена страны у региона с указанным кодом
    public static $change_country = array(
        '703883'=>'185',     // Региону Крым вместо Украины ставим Россию
        '694422'=>'185'
    );

    // Для подмены регионов в форме поиска объяв, 'регион (совпадает с городом)'=>'регион'
    public static $alter_regions = array(
        // регион Москва и Московская область
        '524894'=>'524925',
        // регион Санкт-Петербург и Ленинградская область
        '536203'=>'536199',
        //регион Севастополь и Республика Крым
        '694422'=>'703883'
