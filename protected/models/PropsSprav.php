...
class PropsSprav extends CActiveRecord
{
    ...
    // Для формирования титулов страниц со списками
    // bOris (14:53:11 16/01/2016)
    // <действие> - это если доска о продаже, то "купить"
    // если о покупке, то "продать"
    // если о снятии, то "сдать"
    // если о сдаче, то "снять"
    public static $anti_category_theme = array(
        'продать' => array(7063,7212,7298,7327,7340,7352,7363),
        'купить' => array(2971,7061,7210,7296,7325,7338,7350,7361),
        'снять' => array(7062,7211,7297,7326,7339,7351,7362),
        'сдать' => array(7064,7213,7299,7328,7341,7353,7354)
    );

    // Для карты категорий
    // коды свойств первого уровня для которых нужно извлечь списки второго уровня
    public static $sitemap_ps_id_first_for_second = array(
        6206,   // Противоугонные устройства
        6609,   // Для дома
        6611,   // Для индивидуального ухода
        6610,   // Для кухни
        6612,   // Климатическое оборудование
        7296,   // Дома дачи коттеджи / Продам
        7297,   // Дома дачи коттеджи / Сдам
        7338,   // Коммерческая недвижимость / Продам
        7339,   // Коммерческая недвижимость / Сдам
        7350,   // Гаражи и машиноместа / Продам
        7351,   // Гаражи и машиноместа / Сдам
        7361,   // Недвижимость за рубежом / Продам
        7362,   // Недвижимость за рубежом / Сдам
        7466,   // Женская одежда
        7467,   // Мужская одежда
        7615,   // Для девочек
        7616,   // Для мальчиков
